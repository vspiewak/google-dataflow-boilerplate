...
package com.github.vspiewak.dataflow.utils;
...
import com.github.vspiewak.dataflow.options.DataflowExampleOptions;
import com.github.vspiewak.dataflow.options.ExampleBigQueryTableOptions;
import com.github.vspiewak.dataflow.options.ExamplePubsubTopicAndSubscriptionOptions;
import com.github.vspiewak.dataflow.options.ExamplePubsubTopicOptions;
...
public class DataflowExampleUtils {
  ...
  private void tearDown() {
    ...
    ExamplePubsubTopicAndSubscriptionOptions pubsubOptions =
        options.as(ExamplePubsubTopicAndSubscriptionOptions.class);
    if (!pubsubOptions.getPubsubTopic().isEmpty() && pubsubOptions.getDeleteTopicAtShutdown()) {
      try {
      ...
      if (!pubsubOptions.getPubsubSubscription().isEmpty() && pubsubOptions.getDeleteSubscriptionAtShutdown()) {
        try {
